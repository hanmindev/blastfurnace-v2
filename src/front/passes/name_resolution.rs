...
use crate::front::passes::name_resolution::visitor::{ResolverError, ResolveResult};
...
impl NameResolver {
    pub fn run(module_id: ModuleId, definitions: &mut Vec<Definition>) -> Result<(), ResolverError> {
